...
######### MAKE INFO FOR OWN AGENT #########

.PHONY: RepastHPC_Multi_Agent_Model
RepastHPC_Multi_Agent_Model: clean_compiled_files
	$(MPICXX) $(REPAST_HPC_DEFINES) $(BOOST_INCLUDE) $(REPAST_HPC_INCLUDE) -I./include -c ./src/Main.cpp -o ./objects/Main.o
	$(MPICXX) $(REPAST_HPC_DEFINES) $(BOOST_INCLUDE) $(REPAST_HPC_INCLUDE) -I./include -c ./src/Model_Calculations.cpp -o ./objects/Model_Calculations.o
	$(MPICXX) $(REPAST_HPC_DEFINES) $(BOOST_INCLUDE) $(REPAST_HPC_INCLUDE) -I./include -c ./src/Agent_Source.cpp -o ./objects/Agent_Source.o
	$(MPICXX) $(BOOST_LIB_DIR) $(REPAST_HPC_LIB_DIR) -o ./bin/Multi_Agent_Model.exe  ./objects/Main.o ./objects/Model_Calculations.o ./objects/Agent_Source.o $(REPAST_HPC_LIB) $(BOOST_LIBS)



.PHONY: RepastHPC_Multi_Agent_Model
RepastHPC_Multi_Agent_Model : copy_RepastHPC_Multi_Agent_Model RepastHPC_Multi_Agent_Model

.PHONY: copy_RepastHPC_Multi_Agent_Model
copy_RepastHPC_Multi_Agent_Model : clean
	cp -r ../RepastHPC/Multi_Agent_Model/* ./


.PHONY: compare_RepastHPC_Multi_Agent_Model
compare_RepastHPC_Multi_Agent_Model:
	@echo "Comparing Multi_Agent_Mode_Agent_Class.h:"
	-@diff ../RepastHPC/Multi_Agent_Model/include/_Agent_Class.h ./include/Multi_Agent_Model.h
	@echo "Comparing Multi_Agent_Model_Model_Class.h:"
	-@diff ../RepastHPC/Multi_Agent_Model/include/Model_Calculations.h ./include/Model_Calculations.h
	@echo "Comparing Multi_Agent_Model_Agent_Source.cpp:"
	-@diff ../RepastHPC/Multi_Agent_Model/src/Agent_Source.cpp ./src/Agent_Source.cpp
	@echo "Comparing Multi_Agent_Model_Model_Calculations.cpp:"
	-@diff ../RepastHPC/Multi_Agent_Model/src/Model_Calculations.cpp ./src/Model_Calculations.cpp
	@echo "Comparing Multi_Agent_Model_Main.cpp:"
	-@diff ../RepastHPC/Multi_Agent_Model/src/Main.cpp ./src/Main.cpp
